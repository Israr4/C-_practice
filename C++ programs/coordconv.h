...
struct CylindricalCoordinate
{
        ...
        CylindricalCoordinate cartesian_to_cylindrical(CartesianCoordinate cartesian_point)  //because we cannot use structure here  without its nama as a data type
        {
       ...
       CartesianCoordinate cylindrical_to_cartesian(CylindricalCoordinate cylindrical_point)  //because we cannot use structure here  without its nama as a data type
        {
